...
select
  ...
  '리안은 마력 측정 수정구 앞에 섰다. 그것이 마탑을 뒤집을 시험이 될 줄은 그때의 리안은 몰랐다. 시험관이 손을 올리라고 했다. 훗날 사람들은 이날을 리안의 첫날이라 불렀다.', null, '{"maxChars":120,"minVerbs":3,"forbidLabel":"서술자가 미리 말해 주거나 억지로 끊는 표현","forbidWords":["훗날","될 줄","과연","그때였다","다음 화","운명","몰랐"],"forbidDisplay":["훗날","될 줄은","과연","그때였다","다음 화","운명","몰랐다"],"forbidPassageCopy":true,"ai_shadow":["signal"]}'::jsonb,
  'original', 'fantasy', 'planned',
  2, 'ca-crystal-exam'
