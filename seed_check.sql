...
insert into expect (source_key, instr_md5, instr_len, pass_md5, pass_len, cfg) values
  ...
  ('bt-spear-range', 'b0ced2c3c7f3106cce076bd8d1577a8f', 237, '05f646a0dfe80feaa2030191babac2c2', 95, '{"maxChars":200,"minVerbs":4,"requireAll":["서린","무영"],"forbidLabel":"느낌을 말로 대신하는 표현","forbidWords":["끔찍","무서웠","두려웠","압도적","굉장","엄청난","강력","고통","통증","아픔","지독","그때였다","과연"],"forbidDisplay":["끔찍하다","무섭다","두렵다","압도적","굉장하다","엄청나다","강력하다","고통","통증","아픔","지독하다","그때였다","과연"],"forbidPassageCopy":true,"ai_shadow":["support","tell"],"ai_hint_material":"창은 뒷손이 밀어야 찌르기가 나가고, 앞손이 창대를 감아쥐어야 후리기가 나간다.\n찌르기는 곧아서 반 뼘만 틀면 창끝이 몸을 스쳐 지나가고, 후리기는 둥글어서 원 안쪽이 가장 느리다."}'::jsonb),
  ...
  ('bt-low-guard', '7c4e628eb9d9affb72a58695b76d8a2e', 217, '2a6716828d9dd2cfd5e238faef7142a7', 75, '{"maxChars":200,"minVerbs":4,"requireAll":["정후","백리진"],"forbidLabel":"느낌을 말로 대신하는 표현","forbidWords":["끔찍","무서웠","두려웠","압도적","굉장","엄청난","강력","고통","통증","아픔","지독","그때였다","과연"],"forbidDisplay":["끔찍하다","무섭다","두렵다","압도적","굉장하다","엄청나다","강력하다","고통","통증","아픔","지독하다","그때였다","과연"],"forbidPassageCopy":true,"ai_shadow":["support","tell"],"ai_hint_material":"하단 자세는 보통 올려 베기의 준비 자세로 읽힌다."}'::jsonb),
