...
-- 143행짜리 values를 다시 적어야 한다. 임시 테이블로 한 번만 채운다.
--
...
insert into expect (source_key, instr_md5, instr_len, pass_md5, pass_len, cfg) values
  ...
  ('fh-villainess-mirror', '7dbaa0b472b5f45fdc908278b3584efb', 269, '86f75d01b77b90e12ee8738228f8d65c', 162, '{"maxChars":180,"minVerbs":4,"requireAny":["카리엘"],"forbidLabel":"세계부터 설명하는 표현","forbidWords":["제국력","이 세계","옛날 옛적","프롤로그","오래전부터"],"forbidDisplay":["제국력","이 세계는","옛날 옛적","프롤로그","오래전부터"]}'::jsonb),
  ...
  ('fh-release-ball', '674449cf68da94d1a0b6797a47618d24', 209, 'cb03f35067995306f839be136bfa5052', 109, '{"maxChars":180,"minVerbs":4,"requireAny":["서준혁","준혁"],"forbidLabel":"인물을 평가하는 말","forbidWords":["착하","착한","따뜻","다정","친절","배려","좋은 사람","마음씨","인심","불쌍"],"forbidDisplay":["착하다","따뜻하다","다정하다","친절하다","배려하다","불쌍하다"]}'::jsonb),
  ...
  ('fh-burnt-manor', 'be54fcd78412713e6f8e37b891c45e45', 210, '71961912600c6a47dc5dacc01419b791', 111, '{"maxChars":180,"minVerbs":4,"requireAny":["진운"],"forbidLabel":"방법 없이 다짐만 하는 말","forbidWords":["어떻게든","반드시","언젠가","기필코"],"forbidDisplay":["어떻게든","반드시","언젠가","기필코"],"forbidPassageCopy":true}'::jsonb),
  ...
  ('fh-regress-date', '0b9f841e8231de9bc6223d7c069ed98f', 194, 'ed99074bffad7ecd86551a4c773a10b5', 39, '{"maxChars":150,"minVerbs":3,"requireAny":["강도윤","도윤"],"forbidLabel":"세계부터 설명하는 표현","forbidWords":["제국력","이 세계","옛날 옛적","프롤로그","오래전부터"],"forbidDisplay":["제국력","이 세계는","옛날 옛적","프롤로그","오래전부터"],"forbidPassageCopy":true}'::jsonb),
  ...
  ('fh-broken-engagement', '7bd89cfbe2947182c7f2d440f44da594', 190, '4243c21d57e02aedf386bc4b1d88cf01', 72, '{"maxChars":180,"minVerbs":4,"requireAny":["하은수","은수"],"forbidLabel":"세계부터 설명하는 표현","forbidWords":["제국력","이 세계","옛날 옛적","프롤로그","오래전부터"],"forbidDisplay":["제국력","이 세계는","옛날 옛적","프롤로그","오래전부터"],"forbidPassageCopy":true}'::jsonb),
