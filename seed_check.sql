...
insert into expect (source_key, instr_md5, instr_len, pass_md5, pass_len, cfg) values
  ...
  ('rp-axe-gold', '1923f3bd3896a41facdc89d04e9c0444', 23, '0f9bf0b2af8a2a9e2e8730b1cc5efb94', 63, '{"maxChars":45,"minVerbs":3,"maxRepeat":2,"repeatTargets":[{"word":"도끼","max":2},{"word":"나무꾼","max":2},{"word":"산신령","max":1}]}'::jsonb),
  ('rp-heungbu-gourd', 'abe00269b9cf9de6d03bab6f3aad86dd', 43, 'e2f8c891580685e259caf4227588bffd', 57, '{"maxChars":35,"minVerbs":3,"maxRepeat":2,"repeatTargets":[{"word":"박","max":2},{"word":"흥부","max":1}]}'::jsonb),
  ('rp-simcheong-sea', '1923f3bd3896a41facdc89d04e9c0444', 23, '969127c7c9ef4e2fa20b1959ee2cf721', 66, '{"maxChars":46,"minVerbs":3,"maxRepeat":2,"repeatTargets":[{"word":"바다","max":2},{"word":"심청","max":2}]}'::jsonb),
  ('rp-kongjwi-jar', '1923f3bd3896a41facdc89d04e9c0444', 23, '7ffaae72a0af461617b9fbc3143baeb7', 53, '{"maxChars":34,"minVerbs":3,"maxRepeat":2,"repeatTargets":[{"word":"물","max":2},{"word":"콩쥐","max":2}]}'::jsonb),
  ('rp-magpie-bridge', '1923f3bd3896a41facdc89d04e9c0444', 23, '194e21b3d596b7e05e457fbba96f5285', 51, '{"maxChars":38,"minVerbs":3,"maxRepeat":2,"repeatTargets":[{"word":"다리","max":2}]}'::jsonb),
  ('rp-rabbit-liver', '1923f3bd3896a41facdc89d04e9c0444', 23, '28acee405bdc39308cd3663566e53220', 62, '{"maxChars":44,"minVerbs":5,"maxRepeat":2,"repeatTargets":[{"word":"간","max":2},{"word":"토끼","max":2}]}'::jsonb),
  ('rp-siblings-rope', '691dff2ae02dec8e5210b8edfc12c52e', 42, '1e0a2d5307922a925ff58c990dac26e2', 52, '{"maxChars":40,"minVerbs":3,"maxRepeat":2,"repeatTargets":[{"word":"밧줄","max":2}]}'::jsonb),
  ('rp-goblin-club', 'ffd522567376018a709ddaee7f1973a4', 46, '054a908aaaf3f7865152063f4e49fd47', 62, '{"maxChars":41,"minVerbs":4,"maxRepeat":2,"repeatTargets":[{"word":"방망이","max":2},{"word":"도깨비","max":1}]}'::jsonb),
