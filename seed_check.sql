...
insert into expect (source_key, instr_md5, instr_len, pass_md5, pass_len, cfg) values
  ...
  ('cc-first-pay', 'c51fe4dace5686e96690dfced84524eb', 157, 'a9e6c1cf8e10e91a35cb754b518b31e3', 43, '{"maxChars":100,"minVerbs":3,"requireAll":["조평","유겸"],"forbidPassageCopy":true}'::jsonb),
  ...
  ('cc-night-shift', 'fce79863025a572981e594c206ed93f2', 155, '11aead9eb8826efbcefc9a4a6179b422', 48, '{"maxChars":100,"minVerbs":3,"forbidLabel":"속마음을 직접 말하는 표현","forbidWords":["불안","자존심","증명"],"forbidDisplay":["불안","자존심","증명하다"],"forbidPassageCopy":true}'::jsonb),
  ...
  ('cc-junk-dealer', '41924a5de5a4e6a8850e4371511a23fc', 163, 'e22d9b30faf107e7585f242413509396', 47, '{"maxChars":100,"minVerbs":3,"forbidLabel":"속마음을 직접 말하는 표현","forbidWords":["소중","다정"],"forbidDisplay":["소중하다","다정하다"],"forbidPassageCopy":true}'::jsonb),
