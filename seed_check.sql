...
insert into expect (source_key, instr_md5, instr_len, pass_md5, pass_len, cfg) values
  ...
  ('cc-praise-callout', 'd067bb89c0e135c8487664d7a3a56a21', 127, '890a0ee75d54d1a46001aa83408f7039', 48, '{"maxChars":60,"minVerbs":2,"forbidLabel":"속마음을 직접 말하는 표현","forbidWords":["좋아","기쁘","기뻤","뿌듯"],"forbidDisplay":["좋아하다","기쁘다","뿌듯하다"],"requireAny":["서담"]}'::jsonb),
  ...
  ('cc-ace-siren', '1ffc7fa5738dbce0bd34801a3bcbe501', 135, '44fd55edd70cf83b9edca2308f779247', 54, '{"maxChars":60,"minVerbs":2,"forbidLabel":"속마음을 직접 말하는 표현","forbidWords":["걱정","불안","초조"],"forbidDisplay":["걱정","불안","초조"],"requireAny":["도현"]}'::jsonb),
  ...
  ('cc-night-shift', '74715f705d0a4415055ebeac2ace1837', 136, '11aead9eb8826efbcefc9a4a6179b422', 48, '{"maxChars":60,"minVerbs":2,"forbidLabel":"속마음을 직접 말하는 표현","forbidWords":["불안","자존심","증명"],"forbidDisplay":["불안","자존심","증명하다"],"requireAny":["유겸"]}'::jsonb),
  ...
  ('cc-junk-dealer', '0ab759e5b2d6a31c75cf33c925ed5f2e', 133, 'e22d9b30faf107e7585f242413509396', 47, '{"maxChars":60,"minVerbs":2,"forbidLabel":"속마음을 직접 말하는 표현","forbidWords":["소중","다정"],"forbidDisplay":["소중하다","다정하다"],"requireAny":["셀라"]}'::jsonb),
  ...
  ('cc-flash-crowd', '25f42d1f1edcbf045b99894dd5b9a652', 110, '99916081c5ede049b6c091c68f074406', 43, '{"maxChars":60,"minVerbs":2,"requireAny":["한시우","시우"]}'::jsonb),
