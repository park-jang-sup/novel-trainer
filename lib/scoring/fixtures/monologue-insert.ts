...
// 통과한다.
//
// maxLineWordRepeat: 6의 근거. 좋은 답안 표본(짧은/실제/긴 독백)의 줄 안
// 최대 반복은 1, 뚫기(같은 어절을 15~30번)는 15 이상이다. 3~10 어느 값도
// 지금 표본을 갈랐지만, 좋은 답안 표본이 이 저장소가 만든 것이라 실제보다
// 좁을 수 있어(이번 세션에서 이미 세 번 겪었다) 여유를 뒀다. "안 된다.
// 안 된다. 정말로 안 된다." 같은 서너 번 강조는 웹소설에서 흔하지만 지금
// 표본에는 없다 — 뚫기 쪽 최소 반복이 15라 6과는 충분히 떨어져 있다.
//
