...
//
// 밴드 75~135는 실측값이다. 좋은 답안 48건이 80~130자였고 양쪽에 5자를 뒀다.
// 지문을 고치면 이 수도 다시 재야 한다.
//
...
// 1은 좋은 답안 48건 중 24건(반응 서술판 전부)을 오탐으로 막는다.
// 3은 2와 수가 같아 더 느슨할 이유가 없다.
...
// 상수 하나를 여덟이 함께 쓴다. 밴드(75~135) 안에 있어야 requireAny가
// 일하는지 볼 수 있다.
