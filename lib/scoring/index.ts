...
export { gradeLocal, pendingMorphChecks, countChars, countLetters, countSentences, splitSentences, findForbidden, countOccurrences, gibberishScore, GIB_MAX, charGrams, passageOverlap, OVERLAP_THRESHOLD } from './local'
